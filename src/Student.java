public class Student {
    ...
    public String getStudentInfo() {
        String string1 = "Student Full Name: " + firstName + " " + lastName + "\n";
        string1 += "Grad Year: " + gradYear + "\n";
        string1 += "Number of tests: " + testScoreCount + "\n";
        string1 += "Average Test Score; " + averageTestScore() + "\n";
        string1 += "Is passing: " + isPassing();
        return string1;
    }
}
